    ...
    public class DateTime1
    {
        ...
        public void TestDateTime()
        {
            var tests = new List<KeyValuePair<System.DateTime, byte[]>>()
            {
                ...
                new KeyValuePair<DateTime, byte[]>(new DateTime(9999, 12, 31, 23, 59, 59, 999, DateTimeKind.Utc), new byte[] {211, 35, 42, 168, 127, 252, 129, 152, 240,}),
                new KeyValuePair<DateTime, byte[]>(new DateTime(2015, 11, 17, 0, 0, 0, 0, DateTimeKind.Utc), new byte[] {211, 0, 51, 110, 236, 17, 171, 0, 0,}),
