...
namespace ProGaudi.Tarantool.Client.Converters{
	...
	public class SystemTupleConverter<T1> :IMsgPackConverter<Tuple<T1>>
    {
	...
	public class SystemTupleConverter<T1, T2> :IMsgPackConverter<Tuple<T1, T2>>
    {
        private IMsgPackConverter<object> _nullConverter;
	...
	public class SystemTupleConverter<T1, T2, T3> :IMsgPackConverter<Tuple<T1, T2, T3>>
    {
        private IMsgPackConverter<object> _nullConverter;
	...
	public class SystemTupleConverter<T1, T2, T3, T4> :IMsgPackConverter<Tuple<T1, T2, T3, T4>>
    {
        private IMsgPackConverter<object> _nullConverter;
	...
	public class SystemTupleConverter<T1, T2, T3, T4, T5> :IMsgPackConverter<Tuple<T1, T2, T3, T4, T5>>
    {
        private IMsgPackConverter<object> _nullConverter;
	...
	public class SystemTupleConverter<T1, T2, T3, T4, T5, T6> :IMsgPackConverter<Tuple<T1, T2, T3, T4, T5, T6>>
    {
        private IMsgPackConverter<object> _nullConverter;
        ...
        public Tuple<T1, T2, T3, T4, T5, T6> Read(IMsgPackReader reader)
        {
            var actual = reader.ReadArrayLength();
            if (actual == null)
            {
	...
	public class SystemTupleConverter<T1, T2, T3, T4, T5, T6, T7> :IMsgPackConverter<Tuple<T1, T2, T3, T4, T5, T6, T7>>
    {
        private IMsgPackConverter<object> _nullConverter;
        ...
        public Tuple<T1, T2, T3, T4, T5, T6, T7> Read(IMsgPackReader reader)
        {
            var actual = reader.ReadArrayLength();
            if (actual == null)
            {
