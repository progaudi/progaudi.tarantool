namespace Tarantool.Client.IProto.Data.UpdateOperations
{
    public class UpdateOperation<T>
    {
        ...
        public static UpdateOperation<T> CreateInsert(int fieldNumber, T argument)
        {
            return new UpdateOperation<T>(UpdateOperationType.Insert, fieldNumber, argument);
        }

        public static UpdateOperation<T> CreateAssign(int fieldNumber, T argument)
        {
