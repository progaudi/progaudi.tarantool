...
namespace tarantool_client.Converters
{
    ...
    {
        public void Write(StringSliceOperation value, IBytesWriter writer, MsgPackContext context)
        {
            var stringConverter = context.GetConverter<string>();
            var intConverter = context.GetConverter<int>();

            writer.WriteArrayHeaderAndLength(5);
        ...
        public StringSliceOperation Read(IBytesReader reader, MsgPackContext context, Func<StringSliceOperation> creator)
        {
